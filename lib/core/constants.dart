...
class ConstantsManager {
  static List<SuraDataModel> surasList = [
    ...
    SuraDataModel(
        ...
        versesNumber: "182"),
    SuraDataModel(
        suraIndex: 38, suraNameEn: "Sad", suraNameAr: "ص", versesNumber: "88"),
    SuraDataModel(
        suraIndex: 39,
        suraNameEn: "Az-Zumar",
        suraNameAr: "الزمر",
    ...
    SuraDataModel(
        ...
        versesNumber: "18"),
    SuraDataModel(
        suraIndex: 50, suraNameEn: "Qaf", suraNameAr: "ق", versesNumber: "45"),
    SuraDataModel(
        suraIndex: 51,
